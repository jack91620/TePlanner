package cloud.teplanner.api.infrastructure

import cloud.teplanner.api.auth.HttpBearerAuth
...
class ApiClient(
    ...
    constructor(
        ...
        authNames.forEach { authName ->
            val auth: Interceptor? = when (authName) { 
                "HTTPBearer" -> HttpBearerAuth("bearer")
    ...
    companion object {
        protected const val BASE_URL_KEY: String = "cloud.teplanner.api.baseUrl"
        @Deprecated(
